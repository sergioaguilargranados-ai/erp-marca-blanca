...
export default async function NuevoProveedorPage({ params }: { params: { id: string } }) {
  ...
  const crear = async (formData: FormData) => {
    ...
    await db.insert(proveedores).values(datos)

    redirect(`/admin/empresas/${params.id}/proveedores?success=proveedor-creado`)
  }
      ...
      <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-slate-600 mt-1">Registrar un nuevo proveedor para {empresa.nombre}</p>
          </div>
          <a
